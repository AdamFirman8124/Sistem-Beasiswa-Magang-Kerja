            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item col-2 col-md-auto fs-6"><a href="{{ route('user.beasiswa') }}"
                                class="nav-link">Beasiswa user</a></li>
                        <li class="nav-item col-2 col-md-auto fs-6"><a href="{{ route('user.lomba') }}"
                                class="nav-link">Lomba</a></li>
                        <li class="nav-item col-2 col-md-auto fs-6"><a href="{{ route('user.loker') }}"

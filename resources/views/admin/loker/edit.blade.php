...
@section('content')
    <div class="container-sm my-5">
        <form action="{{ route('admin.loker.update', ['id' => $loker->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
                ...
                <div class="p-5 container-card shadow rounded-3 col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 d-grid">
                            <a href="{{ route('admin.loker') }}" class="btn btn-outline-dark btn-cancle btn-lg mt-3 fw-bold"><i class="bi-arrow-left-circle me-2"></i> Cancel</a>
                        </div>
                        <div class="col-md-6 d-grid">
